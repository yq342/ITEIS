...
while line1:
    ...
    for temp_site in all_site:
        ...
        goal_pd_Left_Right_BZ = goal_pd[((goal_pd["Q_end"] == 100) & (goal_pd["T_start"] == 0)) | (goal_pd["Q_start"] == 0) & (goal_pd["T_end"] == goal_pd["T_size"])]
        goal_pd_Left_BZ = goal_pd[(goal_pd["Q_end"] == 100) & (goal_pd["T_start"] == 0)]
    ...
    for temp_site in all_site:
        ...
        if temp_site not in list(goal_pd_1.index):
            ...
            goal_pd_Left_Right_BZFK = goal_pd[((goal_pd["Q_end"] >= 90) & (goal_pd["T_start"] <= 10)) | (
                        (goal_pd["Q_start"] <= 10) & (goal_pd["T_end"] >= goal_pd["T_size"] - 10))]
            goal_pd_Left_BZFK = goal_pd[(goal_pd["Q_end"] >= 90) & (goal_pd["T_start"] <= 10)]
